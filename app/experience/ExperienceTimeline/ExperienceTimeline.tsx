    ...
    return (
        <>
            <Stack align="center" justify="center" p="xl">
                <Text className={classes.title}>My Experience</Text>
                <Text c="white" size="lg" ta="center">
                    Below is a summary of my experience, whether it be professional or personal. Feel free to check out
                    my <Anchor href="/resume">résumé</Anchor> for a one-page summary. Click on each item to find out
                    more details about each experience!
                </Text>
                <br />
                <Timeline bulletSize={50} lineWidth={5} active={2} color={"#0172AF"}>
                    {experiences.map((experience) => (
                        ...
                        >
                            ...
                            <Text size="sm">{experience.dates}</Text>
                        </Timeline.Item>
                    ))}
                </Timeline>
                <Modal opened={modalData.open} onClose={closeModal} title={"Experience Details"} centered>

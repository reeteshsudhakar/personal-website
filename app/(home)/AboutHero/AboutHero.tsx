        ...
        <Center className={classes.wrapper}>
            ...
            <Stack align='center' justify='center'>
                ...
                >
                    ...
                    business and engineering teams, and data-driven solutions. Some languages and technologies I'm comfortable with include
                    Python, Java, Django, PostgreSQL, React (Next.js + Typescript), Git/GitHub/GitLab, Figma, and Atlassian suite products.
                </Text>
            </Stack>
        </Center>
    );
